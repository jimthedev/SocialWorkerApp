...
```
REACT_NATIVE_PACKAGER_HOSTNAME='your-custom-ip-address-or-hostname' npm start
```

Windows:
```
set REACT_NATIVE_PACKAGER_HOSTNAME='your-custom-ip-address-or-hostname'
npm start
```

The above example would cause the development server to listen on `exp://your-custom-ip-address-or-hostname:19000`.
